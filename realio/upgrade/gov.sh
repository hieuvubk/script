...
./realio-networkd tx gov vote 2 yes  --from validator4 --keyring-backend test --home ~/.realio-network/validator3 --chain-id realionetwork_3301-1 -y --fees 913000ario
./realio-networkd tx gov vote 2 yes  --from validator5 --keyring-backend test --home ~/.realio-network/validator3 --chain-id realionetwork_3301-1 -y --fees 913000ario

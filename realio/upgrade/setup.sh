...
sleep 10
./realio-networkd tx multistaking delegate realiovaloper13x89uzusu8w5wcm8p0ynat9wnnakasfs84ngvt 100000000000000000000arst --from validator1 --keyring-backend test --home ~/.realio-network/validator1 --chain-id realionetwork_3301-1 -y --fees 100ario --gas 4000000
...
./realio-networkd tx multistaking delegate realiovaloper13x89uzusu8w5wcm8p0ynat9wnnakasfs84ngvt 300000000000000000000arst --from validator3 --keyring-backend test --home ~/.realio-network/validator3 --chain-id realionetwork_3301-1 -y --fees 100ario --gas 4000000
sleep 10
./realio-networkd tx multistaking unbond realiovaloper13x89uzusu8w5wcm8p0ynat9wnnakasfs84ngvt 10000000000000000000arst --from validator1 --keyring-backend test --home ~/.realio-network/validator1 --chain-id realionetwork_3301-1 -y --fees 100ario --gas 4000000
